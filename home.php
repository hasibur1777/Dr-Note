                ...
                <table class="table table-hover text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="details.php?nid=<?php echo $row['id']?>" class="btn btn-sm btn-info">View</a>
                                <a href="remove.php?nid=<?php echo $row['id']?>" class="btn btn-sm btn-danger">Remove</a>
                            </td>
                        </tr>
