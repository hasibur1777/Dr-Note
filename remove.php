    ...
    <div class="container mt-3">
        ...
        <div class="">
            <div class="card p-3">
                ...
                if ($_GET['nid']) {
                    $nid = $_GET['nid'];
                        ...
                        if (isset($_POST['btn_remove'])) {
                            $my_query = "DELETE FROM note WHERE id='{$nid}'";
                ...
                Are you sure? <input name="btn_remove" type="submit" class="btn btn-danger" value="Remove"/>
                <a href="home.php" class="btn btn-success">No</a>
                </form>
